   ...
   $db= mysql_connect("localhost","root","");
            ...
            if(mysql_num_rows($result)>0)
            {
               ...
               echo "<form><table align='center' width='30%'><tr><td><label>ENTER NEW EMAIL</label><td><input type='email' name='t1' value='$email' required /><br/></tr>";
                   ...
                   echo "<tr><td colspan='2'><input type='submit' value='' name='b1' style='background: url(images/img].png); width:200px; height:65px' /></tr></table></form>";
            }
if(isset($_REQUEST["b1"]))
{
    ...
    $e=$_REQUEST["t1"];
    $m=$_REQUEST["t2"];
    $q="update tbstudent set email='$e',phone=$m where name='$n'";
    mysql_query($q);
    ?>
     <script>
